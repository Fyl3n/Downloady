...
and `.cursor/mcp.json` (Cursor). Codex: `codex mcp add droppykit -- ~/Documents/droppykit/Scripts/droppykit mcp`.
...
- Guides, as Markdown: `~/Documents/droppykit/Sources/DroppyKit/Documentation.docc/`
  ...
  workflow in full.
- The surface protocols, one file each: `~/Documents/droppykit/Sources/DroppyKit/Capabilities/`
- The host services a droplet calls: `~/Documents/droppykit/Sources/DroppyKit/Services/DropletServices.swift`
  and `~/Documents/droppykit/Sources/DroppyKit/Core/DropletHost.swift`
- The manifest type, with every field documented: `~/Documents/droppykit/Sources/DroppyKit/Bundle/DropletManifest.swift`
- Design tokens and the settings components: `~/Documents/droppykit/Sources/DroppyKit/DesignSystem/`
- A complete droplet that uses every surface: `~/Documents/droppykit/Examples/WorldClock/`
- The compatibility promise and the version ledger: `~/Documents/droppykit/COMPATIBILITY.md`
